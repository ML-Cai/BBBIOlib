...
#define BBBIO_McSPI_CH2                 2	// not pin out , useless
...
#define BBBIO_McSPI_TxRx		0x0				// please reference AM335x Techinal Reference Manual .
#define BBBIO_McSPI_Rx_Only		0x1				// 		session 24.3.1.1 , 24.3.1.2.1 , 24.3.1.2.2
#define BBBIO_McSPI_Tx_Only		0x2

#define BBBIO_McSPI_CLK_MODE0		0x0			// please reference AM335x Techinal Reference Manual .
#define BBBIO_McSPI_CLK_MODE1		0x1			// 		session 24.3.1.3.6 Polarity and Phase
#define BBBIO_McSPI_CLK_MODE2		0x2
#define BBBIO_McSPI_CLK_MODE3		0x3

#define BBBIO_McSPI_D0O_D1I			0x6			// please reference AM335x Techinal Reference Manual .
#define BBBIO_McSPI_D0I_D1O			0x1			//		page :4594 , bit 16~18 , Field : IS , DPE1 , DPE0
